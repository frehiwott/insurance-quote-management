...
export const handleLogin = async (req, res) => {
  ...
  const foundUser = await NewUser.findOne({ username: username });
...
export const handleRefreshToken = async (req, res) => {
  ...
  const foundUser = NewUser.findOne({ refresh_token: refreshToken }).populate(
    "roles"
  );
...
export const handleLogout = async (req, res) => {
  ...
  const foundUser = userDB.users.findOne({ refresh_token: refreshToken });
